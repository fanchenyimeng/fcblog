            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" action="<?php echo U(MODULE_NAME.'/Category/runAddCate');?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input id="cemail" type="comment" class="form-control" name="sort" required="" aria-required="true" value="100">
                                </div>
                            </div>
                            <div class="form-group">
